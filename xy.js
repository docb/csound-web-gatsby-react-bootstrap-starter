  ...
  render() {
    ...
    return (
      ...
      <Stage width={this.h+2} height={this.h+2}>
         <Layer>
            <Shape stroke="green" strokeWith={3} sceneFunc={(context, shape) => {
                  this.props.paint && this.props.paint(context,shape,this.state.x,this.state.y,this.w,this.h);
            }}>
            </Shape>
        </Layer>
        <Layer>
